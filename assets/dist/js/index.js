...
var portfolioListPc = document.querySelectorAll('.portfolio-list>li.motion.type-pc');
var portfolioListMob = document.querySelectorAll('.portfolio-list>li.motion.type-mobile');
...
var activePortfolioByScroll = {
    ...
    setTxtActive: {
        pc: function (scrollBottom, i, arr) {
            ...
            if (txtBox) {
                var CLASS_NAME_ON = 'on';
                var startPoint = scrollBottom - winHeightHalf > window.pageYOffset + currentElement.getBoundingClientRect().top, endPoint = scrollBottom - winHeightHalf < window.pageYOffset + currentElement.getBoundingClientRect().top + currentElement.offsetHeight;
    ...
    action: function (scrollBottom) {
        ...
        portfolioListPc.forEach(function (obj, i, arr) {
            _this.setImgActive.pc(scrollBottom, i, arr);
            _this.setTxtActive.pc(scrollBottom, i, arr);
        });
        portfolioListMob.forEach(function (obj, i, arr) {
            _this.setImgActive.mob(scrollBottom, i, arr);
            _this.setTxtActive.mob(scrollBottom, i, arr);
        });
    }
};
...
var motionContactAreaByScroll = {
    ...
    get: function (winInnerHeight) {
        ...
        this.actionScrollPoint.moveJoinTxt.showReady =
            window.pageYOffset + actionStyleContactArea_portfolioSection.getBoundingClientRect().top + portfolioSectionHeight + (this.winInnerHeight * .5);
