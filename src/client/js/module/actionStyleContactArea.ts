...
let portfolioSection = document.querySelector(
  '#portfolio-section',
) as HTMLElement;
...
export const motionContactAreaByScroll: {
  ...
  get(winInnerHeight: number) {
    ...
    portfolioSection = document.querySelector(
      '#portfolio-section',
    ) as HTMLElement;
  ...
  rotateYForm(degree: any): void {
    const centerWrap = contactSection.querySelector(
      '.center-wrap',
    ) as HTMLElement;
  ...
  moveJoinLine(startScroll: number, endScroll: number): void {
    ...
    let scaleXValue: number = this.convertScrollToPercentage(
      startScroll,
      endScroll,
      maxScaleXValue,
      this.scrollBottom,
  ...
  setOpacity(
    ...
    let opacityValue = this.convertScrollToPercentage(
      startScroll,
      endScroll,
      maxOpacity,
      this.scrollBottom,
  ...
  moveJoinTxt(startScroll: number, endScroll: number): void {
    ...
    let positionValue: number =
      maxpositionValue -
      this.convertScrollToPercentage(
        startScroll,
        endScroll,
        maxpositionValue,
        this.scrollBottom,
  ...
  moveEmboss(startScroll: number, endScroll: number): void {
    const opacity = this.setOpacity(startScroll, endScroll, 0, 0.6);
    const maxShadowSizeValue = 0.4;
    let shadowSizeValue = this.convertScrollToPercentage(
      startScroll,
      endScroll,
      maxShadowSizeValue,
      this.scrollBottom,
  ...
  scrollHandler(scrollBottom: number): void {
    ...
    contactSectionHeading.style.opacity = `${
      1 -
      this.setOpacity(
        this.actionScrollPoint.heading.fadeInEnd,
        this.actionScrollPoint.heading.scaleEnd,
...
export const bindContactForm = () => {
  const contactFormTag = document.querySelectorAll(
